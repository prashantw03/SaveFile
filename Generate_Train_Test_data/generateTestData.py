...
end_index = 50    # Replace with your actual end line index (0-based)
...
# Prepare lists to hold the log lines and their labels
log_data = []
normal_log_data = []
anomaly_log_data = []
...
log_df.to_csv('../data/test_log_data.csv', index=False)
normal_log_df.to_csv('../data/test_normal_log_data.csv', index=False)
anomaly_log_df.to_csv('../data/test_anomaly_log_data.csv', index=False)
